...
def createVoucher(request):
    ...
    if request.method=='POST':
        ...
        total= float(amnt1)+float(amnt2)+float(amnt3)
        if 'KES' in source:
            currency='KES'
